    ...
    <div class="col-xs-12 col-md-12 inner" >
        ...
        <form action="#" method="get" class="dx-form form-horizontal">
            <div class="form-group form-group-lg dx-form-fieldset" >
                <label class="col-sm-12 col-xs-12">访问日志列表</label>
            </div>

            <div class="form-group ">
                <div class="col-sm-12 col-xs-12">
                    <table id="action-table" width="70%" class="table table-bordered table-hover dataTable" >
                        <thead>
                        <tr>
                            <th>IP</th>
                            <th>用户</th>
                            <th>时间</th>
                            <th style="width: 50px">请求</th>
                            <th>状态</th>
                            <th>大小</th>
                        </tr>
                        </thead>
        ...
        datatable = $('#action-table').dataTable({
            ...
            "aoColumns": [
                ...
                },
                {
                    "sDefaultContent": "",
                    "fnRender": function (obj) {
                        if(obj.aData.request.length > 100){
                            return obj.aData.request.substring(0, 80)+ "....";
                        }else{
                            return obj.aData.request;
                        }
            ...
            "bProcessing": false,
            "bServerSide": true,
            "sAjaxSource": '${ctx}' + "/result/accessLogList",
